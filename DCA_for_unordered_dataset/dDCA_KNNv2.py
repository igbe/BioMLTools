...
import pandas as pd
from myclassifiers import NsaConstantDetectorClassifier
...
if __name__ == '__main__':
    ...
    for multiplier in multiplier_list:
        ...
        #label = y_test
        #print label
        dc = deterministicDCA(anomaly_threshold,num_of_dc_selected = num_of_dc_selected,lifespan = 10,class_label = (-1,1),threshold =(5, 15),signal_weights = ([0,1,1],[0,1,-2])) #[0, 1, 2], [0, 1, -2]
